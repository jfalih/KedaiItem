    ...
    <main class="page-wrapper">
        ...
        <div class="container d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between align-items-center pt-2">
          ...
          <div class="d-flex">
            ...
            <div class="text-sm-end">
              <div class="text-light fs-base">Rating penjual</div>
              @include('components.shops.stars.default',['rating' => 5])
              <div class="text-light opacity-60 fs-xs">Berdasarkan dari 98 review</div>
            </div>
          </div>
        </div>
      </div>
      <div class="container pb-5 mb-2 mb-md-4">
        <div class="row">
          ...
          <!-- Content  -->
          @include('components.sections.vendors.product')
        </div>
      </div>
    </main>
@endsection