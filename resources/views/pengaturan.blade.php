                  ...
                  <div class="tab-pane fade show active" id="profile" role="tabpanel">
                    ...
                    <div class="@if(Auth::user()->nomorhp_verified_at != null) col-sm-12 @else col-sm-6 @endif">
                      <div class="bg-danger rounded-3 p-4 mb-4">
                        ...
                        <button class="btn btn-light btn-shadow btn-sm" type="button"><i class="ci-mail me-2"></i>Verifikasi Sekarang</span></button>
                      </div>
                    </div>
                    @endif
                    ...
                    <div class="@if(Auth::user()->email_verified_at != null) col-sm-12 @else col-sm-6 @endif">
                      <div class="bg-warning rounded-3 p-4 mb-4">
                        ...
                        <button class="btn btn-light btn-shadow btn-sm" type="button"><i class="ci-phone me-2"></i>Verifikasi Sekarang</span></button>
                      </div>
                    </div>
                    @endif
                    </div>
